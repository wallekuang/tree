...
bool Hflag, siflag, cflag, Xflag, Jflag, duflag, pruneflag, MDflag;
...
/* Until I get rid of this hack, make it linux/cygwin/HP nonstop only: */
  ...
  if (Hflag) {
    ...
    listdir = needfulltree ? markdown_rlistdir : markdown_listdir;
  }
  else {
